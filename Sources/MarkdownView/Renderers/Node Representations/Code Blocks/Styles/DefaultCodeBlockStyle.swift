    ...
    var codeSource: some View {
        Group {
            if let attributedCode {
                ...
                ForEach(Array(lines.enumerated()).prefix(codeBlockConfiguration.showFullCode ? nil : 15), id: \.offset) { index, line in
        ...
        if #available(iOS 18.0, *) {
            code
                ...
                .safeAreaInset(edge: .top, spacing: 0) {
                    ...
                    .background {
                        Rectangle().foregroundStyle(colorScheme == .dark ? .gray.opacity(0.1) : .white.opacity(0.5))
                    }
