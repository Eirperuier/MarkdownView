...
struct HeadingPaddings: Sendable {
    private var _padding: [Int : EdgeInsets] = [
        1 : EdgeInsets(top: 0, leading: 0, bottom: 24, trailing: 0),
        2 : EdgeInsets(top: 0, leading: 0, bottom: 18, trailing: 0),
        3 : EdgeInsets(top: 0, leading: 0, bottom: 12, trailing: 0),
        4 : EdgeInsets(top: 0, leading: 0, bottom: 10, trailing: 0),
        5 : EdgeInsets(top: 0, leading: 0, bottom: 8, trailing: 0),
        6 : EdgeInsets(top: 0, leading: 0, bottom: 5, trailing: 0),
    ]
